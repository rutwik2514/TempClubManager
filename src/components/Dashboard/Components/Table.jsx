      ...
      <section className="card p-3" style={{ width: 'fit-content', height: 'fit-content' }}>
        {setShow && (
          <div className="my-4" style={{ width: '30vw' }}>
            <h4 style={{ width: '30vw' }}>Club Data:</h4>
            <p className="my-2">Please select College Name</p>
        ...
        {showBranch && (
          <div className="my-3" style={{ width: '30vw' }}>
            <p className="my-2" style={{ width: '30vw' }}>Please select Club Name</p>
            <div className="d-flex justify-content-center align-items-center"></div>
            <select
              className="form-select p-1"
              aria-label="Default select example"
              ...
              style={{ width: '30vw' }}
            >
              <option key="selectBranch">Select Club Name</option>
              {branchElements}
            </select>
          </div>
        )}
